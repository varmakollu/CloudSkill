...
wget https://github.com/varmakollu/CloudSkill/blob/main/Deploy%20a%20Compute%20Instance%20with%20a%20Remote%20Startup%20Script%20Challenge%20Lab/resources-install-web.sh
