...
gcloud container clusters create $CLUSTER_NAME --release-channel regular --cluster-version latest --enable-autoscaling --no-enable-ip-alias --num-nodes 3 --max-nodes 6 --min-nodes 2
