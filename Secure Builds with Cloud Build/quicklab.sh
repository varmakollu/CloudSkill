...
while true; do
    ...
    #   # Submit the build
    if [ $? -eq 0 ]; then
        echo "Build submission successful. please like and subscribe to tutorialboy (https://www.youtube.com/@tutorialboy24)."
        break
    else
        echo "Error: Submit the build is processing. (https://www.youtube.com/@tutorialboy24)."
    fi
    sleep 60
done
