...
while [ "$deploy_success" = false ]; do
  if deploy_function; then
    echo "Function deployed successfully.(https://www.youtube.com/@tutorialboy24)"
    deploy_success=true
  else
    echo "Deployment Retrying, please subscribe to TutorialBoy (https://www.youtube.com/@tutorialboy24).."
    sleep 10
  fi
done
